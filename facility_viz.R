...
get_grids <- function(current_shp, nrow, ncol){
...
getting_zoomin_graph <- function(current_bbox_df,
                                 current_shp_fortify, current_facilities, grid_lines){
...
lga_viz <- function(current_shp_fortify, current_facilities){
  ...
  getting_lga_graph(current_shp_fortify, 
                    current_facilities, bbox_data, grid_lines)
